...
public class JackhammerWalkDetection : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        m_CurrentAnimation = m_PlayerAnimationDB.GetAnimationById(JACKHAMMER_WALK);
