...
public class JackhammerActionDetection : StateMachineBehaviour
{
    ...
    const int JACKHAMMER_ACTION = 16;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        m_CurrentAnimation = m_PlayerAnimationDB.GetAnimationById(JACKHAMMER_ACTION);
