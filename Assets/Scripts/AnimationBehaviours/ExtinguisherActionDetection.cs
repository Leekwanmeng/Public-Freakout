...
public class ExtinguisherActionDetection : StateMachineBehaviour
{
    ...
    const int EXTINGUISHER_ACTION = 13;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        m_CurrentAnimation = m_PlayerAnimationDB.GetAnimationById(EXTINGUISHER_ACTION);
